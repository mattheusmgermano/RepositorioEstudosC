...
namespace ContratoDeTrabalho
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var contrato = new
            {
                Empresa = "Germano Serviços Malucos Ltda.",
                Funcionario = "Mario Kemario",
                DataInicio = new DateTime(2018, 1, 1),
                Cargo = "Encanador",
                Salario = new Money(Currency.BRL, 3999.00)
            };
...
Cláusula 1ª - O EMPREGADO prestará ao EMPREGADOR, a partir de {contrato.DataInicio} e assinatura deste instrumento, seus trabalhos exercendo a função de {contrato.Cargo}, prestando pessoalmente o labor diário no período compreendido entre 9 horas às 18 horas, e intervalo de 1 hora para almoço;

Cláusula 2ª - Não haverá expediente nos dias de sábado, sendo prestado a compensação de horário semanal;

Cláusula 3ª - O EMPREGADOR pagará mensalmente, ao EMPREGADO, a título de salário a importância de {contrato.Salario} {new MoedaBRL(contrato.Salario).Extenso()}, com os descontos previstos por lei;
